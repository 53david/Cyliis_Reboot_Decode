...
public class ShooterCalculator {
    ...
    public static double fwOffset = 50;
    ...
    public static double hoodRegression(double velocity) {
        return Math.clamp(((0.0000241756 * Math.pow(velocity, 3) - 0.122862
                * Math.pow(velocity, 2) + 208.82546 * velocity - 114884.567) * 0.0001)+hoodOffset,0.124,0.6);
